                ...
                <div class="col-md-6 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" onsubmit="submitForm()" method="POST"
                                    action="<?= base_url('admin/product/save-update') ?>" enctype="multipart/form-data">
                                    <input type="hidden" name="product_id" value="<?= $product['id'] ?>">
                                    <div class="alert alert-dismissible fade show" role="alert"
                                        style="background-color:rgba(237, 237, 6, 0.50)">
                                        <p class="text-dark font-weight-light">Saat mengupload gambar disarankan
                                            menggunakan ukuran 512 x 512. Dengan panjang 512 pixel dan lebar 512 pixel.
                                        </p>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 form-group mb-2">
                                                ...
                                                ?>
                                                <label class="font-weight-normal mt-2">Foto <?= $key + 1 ?></label>
                                                <div class="custom-file">
                                                    <input type="file" name="product_image[]"
                                                        id="product_image_<?= $key ?>" class="custom-file-input">
                                                    <label for="product_image_<?= $key ?>" class="custom-file-label"
                                                        id="file-label">PILIH FILE</label>
                                                </div>
